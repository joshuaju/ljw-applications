...
public class MakeTransactionController
{
    ...
    private void initialize()
    {
        ...
        FilteredList<Account> filteredAccounts = new FilteredList<>(accountListProperty,
                account -> {
                    boolean receiverIsSelectedAccount = selectedAccountProperty.get() != null
                            && selectedAccountProperty.get().getId().equals(account.getId());
        ...
        cbReceivers.disableProperty()
                   .bind(Bindings.createBooleanBinding(() -> !rbTransfer.equals(tgTransaction.getSelectedToggle()), tgTransaction
                           .selectedToggleProperty()));
        cbOverdraw.disableProperty()
                  .bind(Bindings.createBooleanBinding(() -> tgTransaction.getSelectedToggle() == null || rbDeposit.equals(tgTransaction
                          .getSelectedToggle()), tgTransaction.selectedToggleProperty()));
    }
