package de.ljw.aachen.flow.app.controller;

import de.ljw.aachen.flow.app.controls.DescriptionTableCell;
import de.ljw.aachen.flow.app.controls.InstantTableCell;
import de.ljw.aachen.flow.app.controls.MoneyTableCell;
import de.ljw.aachen.flow.data.Account;
import de.ljw.aachen.flow.data.Money;
import de.ljw.aachen.flow.data.Transaction;
import de.ljw.aachen.flow.logic.CalculateBalance;
import de.ljw.aachen.flow.logic.GetRelevantTransactions;
